...
from entry.models import Post, Category, PostCategory
...
register.inclusion_tag('pages/category_list.html')(sidebar_category_list)
...
register.inclusion_tag('pages/date_list.html')(sidebar_date_list)
